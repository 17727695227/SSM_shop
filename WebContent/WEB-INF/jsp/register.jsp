...
<script>
    ...
    function checkUsername(){
		...
		// 3.打开连接
		xhr.open("GET","${pageContext.request.contextPath}/shop/findByName.do?time="+new Date().getTime()+"&username="+username,true);
		// 4.发送
		xhr.send(null);
	}
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"  action="${pageContext.request.contextPath}/shop/register.do" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						<table>
							<tbody><tr>
								<th>
